...
gtf <- import("../data/gencode.v29.appris_principle_1.gtf")
...
exome_hek293t_file <- "../data/dna_variants/HEK293_allDNA.rds"
exome_hepg2_file <- "../data/dna_variants/HepG2_allDNA.rds"
